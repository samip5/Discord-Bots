...
class Misc:
	...
	@commands.command(name='giphy', description="Giphy API integration (WIP)", brief="Giphy API (WIP)")
	...
	@commands.command(name='cat', description="Gives you a random cat picture", brief="Returns random image of a cat", pass_context=True)
