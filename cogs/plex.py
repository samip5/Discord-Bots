...
class Plex:
	...
	async def query_plex_streams_though_tautulli(self):
		"""
			Returns currently playing streams on Plex.
		"""
		tautulli_url = "{tautulli_base_url}api/v2?apikey={api_key}&cmd=get_activity".format(
			tautulli_base_url=TAUTULLI_BASE_URL, api_key=TAUTULLI_API_KEY)
